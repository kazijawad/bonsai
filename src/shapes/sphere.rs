    ...
    fn new(
        ...
        Self {
            shape: ShapeProperties {
                ...
                world_to_object: object_to_world.clone(),
                reverse_orientation,
...
impl Shape for Sphere {
    ...
    fn intersect(
        ...
        let ray = self.shape.world_to_object.transform_ray_with_error(
            r,
            &mut origin_error,
            &mut direction_error,
        );
        ...
        let theta = math::clamp(p_hit.z / self.radius, -1.0, 1.0).acos();
        ...
        let p_error = math::gamma(5.0) * Vec3::from(p_hit).abs();
    ...
    fn intersect_occurs(&self, r: &Ray, _test_alpha_texture: bool) -> bool {
        // Transform ray to object space.
        let mut origin_error = Vec3::default();
        let mut direction_error = Vec3::default();
        let ray = self.shape.world_to_object.transform_ray_with_error(
    ...
    fn sample(
        &self,
        u: &crate::geometries::point2::Point2,
        pdf: &mut Float,
    ...
    fn transform_swaps_handedness(&self) -> bool {
        self.shape.transform_swaps_handedness
    }
}
